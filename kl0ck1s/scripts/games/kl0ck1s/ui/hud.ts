...
export class HUD {
    ...
    scoreEl: HTMLElement;
    linesEl: HTMLElement;
    linesRowEl: HTMLElement | null;
    bestEl: HTMLElement;
    bestRowEl: HTMLElement | null;
    overlayEl: HTMLElement;
    nextPieceCardEl: HTMLElement | null;
    statsStatusEl: HTMLElement | null;
    difficultyEl: HTMLElement | null;
    difficultyBarEl: HTMLElement | null;
    statsCardEl: HTMLElement | null;
    statusCardEl: HTMLElement | null;
    i18n: import("../services/i18n.js").I18n | null;
    _statusOverride: string | null;
    timeEl: HTMLElement | null;
    droughtEl: HTMLElement | null;
    tetrisRateEl: HTMLElement | null;
    ppsEl: HTMLElement | null;
    objectiveEl: HTMLElement | null;
    objectiveRowEl: HTMLElement | null;
    objectiveBarEl: HTMLElement | null;
    objectiveBarTrackEl: HTMLElement | null;
    difficultyRowEl: HTMLElement | null;
    _cache: Record<string, string | number | boolean | null | undefined>;
    ...
    setPlaying(isPlaying: boolean, mode: string | null = null): void {
