...
export class Matrix extends ThemeEffect {

    count: 0 | number;
    y: Float32Array<ArrayBuffer>;
    speed: Float32Array<ArrayBuffer>;
    charIndex: Uint8Array<ArrayBuffer>;
    switchEvery: Uint8Array<ArrayBuffer>;
    tick: Uint8Array<ArrayBuffer>;
    tailLength: Uint8Array<ArrayBuffer>;
    _columnSprites: HTMLCanvasElement[][];

    constructor(canvas, ctx = null) {
        super(canvas, ctx, 2, 0.5);
